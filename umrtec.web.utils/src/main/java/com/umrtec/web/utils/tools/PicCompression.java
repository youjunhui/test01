 ...
 * 
 * @author 
 * @version [版本号, 2013-8-7 上午10:33:17]
 */
public class PicCompression {
	...
	public static void main(String str[]) throws IOException {
		...
		System.out.println(PicCompression.doCompress("F:/01UK.jpg", 70, 70, 1, "_small", true));
		// System.out.print("ok...");
	}
}
